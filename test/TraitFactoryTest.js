...
contract('TraitFactory', function(accounts) {
    ...
    before(async () => {
        ...
        // The TraitFactoryWrapper inherits TraitFactory, so
    ...
    it("should allow sysadmin to create a trait", async function() {
        ...
        const traitId = (await contract.createTrait.call(generation, series, gender, gene, rarity, variation, name, svg, {from: sysAdmin})).toNumber();
        assert.equal(traitId, id, "Trait id wasn't returned");

        // Now call the function for real and write the data
        let result = await contract.createTrait(generation, series, gender, gene, rarity, variation, name, svg, {from: sysAdmin});
    ...
    it("should not allow non-sysadmins to create traits", async function() {
        ...
        await exceptions.catchRevert(
            contract.createTrait(generation, series, gender, gene, rarity, variation, name, svg, {from: nonSysAdmin})
        );
    ...
    it("should allow sysadmin to create a trait and extend its art", async function() {
        ...
        const {generation, gender, gene, name, series, svg, variation, rarity} = traitData.too_big[3];
        let id = new BN(2,10);
        ...
        let createResult = await contract.createTrait(generation, series, gender, gene, rarity, variation, name, svg1, {from: sysAdmin, gas: constants.MAX_GAS});
    ...
    it("should not allow sysadmin to create trait with bad value for generation", async function() {
        ...
        const {generation, gender, gene, name, series, svg, variation, rarity} = badGeneration;
    ...
    it("should not allow sysadmin to create trait with bad value for gender", async function() {
        ...
        const {generation, gender, gene, name, series, svg, variation, rarity} = badGender;
    ...
    it("should not allow sysadmin to create trait with bad value for gene", async function() {
        ...
        const {generation, gender, gene, name, series, svg, variation, rarity} = badGene;
    ...
    it("should not allow sysadmin to create trait with empty array for series", async function() {
        ...
        const {generation, gender, gene, name, series, svg, variation, rarity} = noSeries;
    ...
    it("should not allow sysadmin to create trait with bad value for series", async function() {
        ...
        const {generation, gender, gene, name, series, svg, variation, rarity} = badSeries;
