...
[AvastarMinter-setTeleporterContract-address-]: #AvastarMinter-setTeleporterContract-address-
...
[AvastarMinter-TeleporterContractSet-address-]: #AvastarMinter-TeleporterContractSet-address-
...
- [`setTeleporterContract(address _address)`][AvastarMinter-setTeleporterContract-address-]
...
- [`checkFranchiseBalance()`][AvastarMinter-checkFranchiseBalance--]
...
- [`TeleporterContractSet(address contractAddress)`][AvastarMinter-TeleporterContractSet-address-]
...
### <span id="AvastarMinter-setTeleporterContract-address-"></span> `setTeleporterContract(address _address)` (external)
...
### <span id="AvastarMinter-deposit--"></span> `deposit()` (external)
...
### <span id="AvastarMinter-CurrentGenerationSet-enum-AvastarTypes-Generation-"></span> `CurrentGenerationSet(enum AvastarTypes.Generation currentGeneration)`
...
### <span id="AvastarMinter-TeleporterContractSet-address-"></span> `TeleporterContractSet(address contractAddress)`
